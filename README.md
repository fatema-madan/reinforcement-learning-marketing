...
An intelligent agent interacts with a simulated customer environment, learns from purchase behavior (purchase / no purchase), and continuously improves its discount decisions over time.
...
- High-income customers responded more to large and seasonal discounts  
- Low-income customers showed purchasing behavior even without discounts  
- The model outperformed traditional rule-based marketing approaches  
